...
c = colorbar; c.Label.String = 'CO_2 Saturation (fraction)';
%% =========================================================================
%  Figure 9: Pressure buildup deltaP at injection end — shows where pressure is building up.
% =========================================================================
...
%  Every in-reservoir well location becomes an observation point; pressure/saturation extracted from states.
